...
### Thermostat
- **_GET: /api/thermostat  -> Gets all logged entries_**
- **_GET: /api/thermostat/getById  -> Gets a logged entry by its id*
- **_GET: /api/thermostat/getByAccountId  -> Gets all logged entries matching an account id**
